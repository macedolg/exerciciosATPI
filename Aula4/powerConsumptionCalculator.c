...
int main(void) {
    ...
    // float wSpendDaily = (dailyUse * consumptionDay) ;
    // float wSpendMonthly = (dailyUse * consumptionMonth);
    // float wSpendYearly = (dailyUse * consumptionYear);

    // printf("Cost in Watts = %f \n", wSpendDaily);
